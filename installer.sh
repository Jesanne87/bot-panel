...
surat=$(curl -sS https://raw.githubusercontent.com/msi8888/allow/main/ipmini | grep -w $ipes | awk '{print $4}')
...
EOF
    ...
    fun_bot1() {
      [[ ! -e "/etc/.maAsiss/.Shellbtsss" ]] && {
        wget -qO- https://raw.githubusercontent.com/Jesanne87/bot-panel/BotAPI.sh >/etc/.maAsiss/.Shellbtsss
      }
