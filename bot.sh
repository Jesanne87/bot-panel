...
add_wg() {
    [[ "${callback_query_from_id[$id]}" == "$Admin_ID" ]] || [[ "$(grep -wc ${callback_query_from_id} $User_Active)" != '0' ]] && {
        ShellBot.deleteMessage --chat_id ${callback_query_message_chat_id[$id]} \
              --message_id ${callback_query_message_message_id[$id]}
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ‘¤ CREATE USER WireGuard ðŸ‘¤\n\nUsername:" \
            --reply_markup "$(ShellBot.ForceReply)"
    } || {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "â›” ACCESS DENIED â›”"
...
del_wg() {
    [[ "${callback_query_from_id[$id]}" == "$Admin_ID" ]] || [[ "$(grep -wc ${callback_query_from_id} $User_Active)" != '0' ]] && {
        ShellBot.deleteMessage --chat_id ${callback_query_message_chat_id[$id]} \
              --message_id ${callback_query_message_message_id[$id]}
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ—‘ REMOVE USER WireGuard ðŸ—‘\n\nUsername:" \
            --reply_markup "$(ShellBot.ForceReply)"
    } || {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "â›” ACCESS DENIED â›”"
...
add_wg_trial() {
    if [[ "${callback_query_from_id[$id]}" == "$Admin_ID" ]]; then
        ShellBot.deleteMessage --chat_id ${callback_query_message_chat_id[$id]} \
              --message_id ${callback_query_message_message_id[$id]}
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ‘¤ CREATE TRIAL WireGuard ðŸ‘¤\n\nHow many hours should it last ? EX: 1:" \
            --reply_markup "$(ShellBot.ForceReply)"
    elif [[ "$(grep -wc ${callback_query_from_id} $User_Active)" != '0' ]]; then
            ShellBot.deleteMessage --chat_id ${callback_query_message_chat_id[$id]} \
              --message_id ${callback_query_message_message_id[$id]}
...
ShellBot.InlineKeyboardButton --button 'menu_wg' --line 6 --text 'ðŸ”™ Back ðŸ”™' --callback_data '_gobackwg'
...
unset res_menu_wg
res_menu_wg=''
ShellBot.InlineKeyboardButton --button 'res_menu_wg' --line 1 --text 'âž• Add WireGuard âž•' --callback_data '_res_add_wg'
ShellBot.InlineKeyboardButton --button 'res_menu_wg' --line 3 --text 'â³ Create Trial WG â³' --callback_data '_res_trial_wg'
ShellBot.InlineKeyboardButton --button 'res_menu_wg' --line 4 --text 'ðŸŸ¢ List Member WG ðŸŸ¢' --callback_data '_res_member_wg'
ShellBot.InlineKeyboardButton --button 'res_menu_wg' --line 5 --text 'ðŸ”™ Back ðŸ”™' --callback_data '_res_gobackwg'
...
ShellBot.InlineKeyboardButton --button 'menu_pptp' --line 6 --text 'ðŸ”™ Back ðŸ”™' --callback_data '_gobackpptp'
...
unset res_menu_pptp
res_menu_pptp=''
ShellBot.InlineKeyboardButton --button 'res_menu_pptp' --line 1 --text 'âž• Add PPTP âž•' --callback_data '_res_add_pptp'
ShellBot.InlineKeyboardButton --button 'res_menu_pptp' --line 3 --text 'â³ Create Trial PPTP â³' --callback_data '_res_trial_pptp'
ShellBot.InlineKeyboardButton --button 'res_menu_pptp' --line 4 --text 'ðŸŸ¢ List Member PPTP ðŸŸ¢' --callback_data '_res_member_pptp'
ShellBot.InlineKeyboardButton --button 'res_menu_pptp' --line 5 --text 'ðŸ”™ Back ðŸ”™' --callback_data '_res_gobackpptp'
...
add_trgo() {
    [[ "${callback_query_from_id[$id]}" == "$Admin_ID" ]] || [[ "$(grep -wc ${callback_query_from_id} $User_Active)" != '0' ]] && {
        ShellBot.deleteMessage	--chat_id ${callback_query_message_chat_id[$id]} \
              --message_id ${callback_query_message_message_id[$id]}
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ‘¤ CREATE USER Trojan-GO ðŸ‘¤\n\nUsername:" \
            --reply_markup "$(ShellBot.ForceReply)"
    } || {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "â›” ACCESS DENIED â›”"
...
del_trgo() {
    [[ "${callback_query_from_id[$id]}" == "$Admin_ID" ]] || [[ "$(grep -wc ${callback_query_from_id} $User_Active)" != '0' ]] && {
        ShellBot.deleteMessage	--chat_id ${callback_query_message_chat_id[$id]} \
              --message_id ${callback_query_message_message_id[$id]}
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ—‘ REMOVE USER Trojan-GO ðŸ—‘\n\nUsername:" \
            --reply_markup "$(ShellBot.ForceReply)"
    } || {
        ShellBot.answerCallbackQuery --callback_query_id ${callback_query_id[$id]} \
            --text "â›” ACCESS DENIED â›”"
...
add_trgo_trial() {
    if [[ "${callback_query_from_id[$id]}" == "$Admin_ID" ]]; then
        ShellBot.deleteMessage --chat_id ${callback_query_message_chat_id[$id]} \
              --message_id ${callback_query_message_message_id[$id]}
        ShellBot.sendMessage --chat_id ${callback_query_message_chat_id[$id]} \
            --text "ðŸ‘¤ CREATE TRIAL Trojan-GO ðŸ‘¤\n\nHow many hours should it last ? EX: 1:" \
            --reply_markup "$(ShellBot.ForceReply)"
    elif [[ "$(grep -wc ${callback_query_from_id} $User_Active)" != '0' ]]; then
            ShellBot.deleteMessage --chat_id ${callback_query_message_chat_id[$id]} \
              --message_id ${callback_query_message_message_id[$id]}
...
ShellBot.InlineKeyboardButton --button 'menu_trgo' --line 6 --text 'ðŸ”™ Back ðŸ”™' --callback_data '_gobacktrgo'
...
unset res_menu_trgo
res_menu_trgo=''
ShellBot.InlineKeyboardButton --button 'res_menu_trgo' --line 1 --text 'âž• Add Trojan-GO âž•' --callback_data '_res_add_trgo'
ShellBot.InlineKeyboardButton --button 'res_menu_trgo' --line 3 --text 'â³ Create Trial Trojan-GO â³' --callback_data '_res_trial_trgo'
ShellBot.InlineKeyboardButton --button 'res_menu_trgo' --line 4 --text 'ðŸŸ¢ List Member Trojan-GO ðŸŸ¢' --callback_data '_res_member_trgo'
ShellBot.InlineKeyboardButton --button 'res_menu_trgo' --line 5 --text 'ðŸ”™ Back ðŸ”™' --callback_data '_res_gobacktrgo'
...
ShellBot.InlineKeyboardButton --button 'menu_xray' --line 6 --text 'ðŸ”™ Back ðŸ”™' --callback_data '_gobackxray'
...
unset res_menu_xray
res_menu_xray=''
ShellBot.InlineKeyboardButton --button 'res_menu_xray' --line 1 --text 'âž• Add Xray âž•' --callback_data '_res_add_xray'
#ShellBot.InlineKeyboardButton --button 'res_menu_xray' --line 3 --text 'â³ Create Trial Xray â³' --callback_data '_res_trial_xray'
#ShellBot.InlineKeyboardButton --button 'res_menu_xray' --line 4 --text 'ðŸŸ¢ List Member Xray ðŸŸ¢' --callback_data '_res_member_xray'
ShellBot.InlineKeyboardButton --button 'res_menu_xray' --line 5 --text 'ðŸ”™ Back ðŸ”™' --callback_data '_res_gobackxray'
        ...
        (
            ...
            if [[ ${message_reply_to_message_message_id[$id]} ]]; then
                ...
                'ðŸ‘¤ CREATE USER ðŸ‘¤\n\nUsername:')
                    ...
                    [[ "$sizemax" -gt '10' ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "â›” Use no maximum 10 characters [EX: https://raw.githubusercontent.com/DryanZ/permission/aio/ipmini]")" \
                            --parse_mode html
                        >$CAD_ARQ
                        break
                    }
                ...
                'ðŸ‘¤ CREATE USER VMess ðŸ‘¤\n\nUsername:')
                    ...
                    [[ "$sizemax" -gt '10' ]] && {
                        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
                            --text "$(echo -e "â›” Use no maximum 10 characters [EX: SQUIDVPN]")" \
                            --parse_mode html
                        >$CAD_ARQ
                        break
                    }
